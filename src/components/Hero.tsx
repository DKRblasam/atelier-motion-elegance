...
const Hero = () => {
  return <section id="home" className="relative min-h-screen flex items-center justify-center warm-gradient overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-1/4 left-1/4 w-48 h-48 border border-accent-brown rounded-full animate-float"></div>
        <div className="absolute bottom-1/4 right-1/4 w-24 h-24 border border-accent-brown rounded-full animate-float" style={{
        animationDelay: '1s'
      }}></div>
        <div className="absolute top-1/2 right-1/3 w-8 h-8 bg-accent-brown/10 rounded-full animate-float" style={{
        animationDelay: '2s'
      }}></div>
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 animate-elegant-fade">
            <h1 className="font-dancing text-7xl md:text-9xl font-bold text-warm-brown mb-4">
              <span className="block my-[86px]">Alta</span>
              <span className="block text-accent-brown my-0">Costura</span>
            </h1>
          ...
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-warm-brown/70 mb-12 max-w-3xl mx-auto leading-relaxed font-inter animate-fade-in-up" style={{
          animationDelay: '0.3s'
        }}>
